...
- Updated README.md with v0.10.0 MCP server documentation (PyPI package description)
- Added MCP architecture diagram, tool descriptions, and performance comparison table
- Updated "For Claude Code" section to reflect MCP + agentic integration
...
- **Re-release of 0.8.4**: PyPI package rebuild to ensure complete distribution artifacts
